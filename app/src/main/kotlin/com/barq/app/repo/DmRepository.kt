...
import com.barq.app.nostr.DmConversation
import com.barq.app.nostr.DmMessage
import com.barq.app.nostr.NostrEvent
import com.barq.app.nostr.wipe
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.StateFlow

class DmRepository(context: Context? = null, pubkeyHex: String? = null) {
    private val prefs: SharedPreferences? =
        context?.getSharedPreferences("barq_dm_${pubkeyHex ?: "anon"}", Context.MODE_PRIVATE)
