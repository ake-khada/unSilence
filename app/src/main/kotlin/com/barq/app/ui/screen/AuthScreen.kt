...
import com.barq.app.nostr.RemoteSignerBridge
import com.barq.app.nostr.toHex
import com.barq.app.relay.TorStatus
...
fun AuthScreen(
    ...
    val signerLauncher = rememberLauncherForActivityResult(
        ...
        val pubkeyHex = if (result.startsWith("npub1")) {
            try { com.barq.app.nostr.Nip19.npubDecode(result).toHex() } catch (_: Exception) { return@rememberLauncherForActivityResult }
        } else {
            result
        }
