...
import com.barq.app.nostr.FollowSet
...
import com.barq.app.repo.Nip05Status
import com.barq.app.repo.RelayInfoRepository
import com.barq.app.repo.TranslationRepository
import com.barq.app.ui.component.FollowButton
import com.barq.app.ui.component.FullScreenImageViewer
import com.barq.app.ui.component.PostCard
import com.barq.app.ui.component.QrCodeDialog
import com.barq.app.ui.component.ProfilePicture
import com.barq.app.ui.component.RichContent
                    ...
                    if (pinnedEvents.isNotEmpty()) {
                        ...
                        items(items = pinnedEvents, key = { "pinned-${it.id}" }) { event ->
                            ...
                            val pinnedTranslationState = remember(translationVersion, event.id) {
                                translationRepo?.getState(event.id) ?: com.barq.app.repo.TranslationState()
                            }
                            PostCard(
                                event = event,
