...
import com.barq.app.ui.screen.BroadcastStatusBar
...
import com.barq.app.nostr.LocalSigner
import com.barq.app.nostr.RemoteSigner
import com.barq.app.nostr.SignerIntentBridge
import com.barq.app.nostr.SignResult
import com.barq.app.repo.SigningMode
import android.content.Context
import androidx.compose.runtime.rememberUpdatedState
import com.barq.app.ui.component.NotifBlipSound
import com.barq.app.ui.component.BarqBottomBar
import com.barq.app.ui.component.ZapDialog
import com.barq.app.ui.screen.BlossomServersScreen
import com.barq.app.ui.screen.AuthScreen
import com.barq.app.ui.screen.ComposeScreen
import com.barq.app.ui.screen.DmConversationScreen
import com.barq.app.ui.screen.DmListScreen
import com.barq.app.ui.screen.DraftsScreen
import com.barq.app.ui.screen.FeedScreen
import com.barq.app.ui.screen.ProfileEditScreen
import com.barq.app.ui.screen.RelayScreen
import com.barq.app.ui.screen.ThreadScreen
import com.barq.app.ui.screen.NotificationsScreen
import com.barq.app.ui.screen.SafetyScreen
import com.barq.app.ui.screen.UserProfileScreen
import com.barq.app.ui.screen.ConsoleScreen
import com.barq.app.ui.screen.CustomEmojiScreen
import com.barq.app.ui.screen.SearchScreen
import com.barq.app.ui.screen.SocialGraphScreen
import com.barq.app.ui.screen.BookmarkSetScreen
import com.barq.app.ui.screen.HashtagFeedScreen
import com.barq.app.ui.screen.KeysScreen
import com.barq.app.ui.screen.ListScreen
import com.barq.app.ui.screen.ExistingUserOnboardingScreen
...
import com.barq.app.viewmodel.ComposeViewModel
import com.barq.app.viewmodel.DmConversationViewModel
import com.barq.app.viewmodel.DmListViewModel
import com.barq.app.viewmodel.FeedType
import com.barq.app.viewmodel.FeedViewModel
import com.barq.app.viewmodel.ProfileViewModel
import com.barq.app.viewmodel.RelayViewModel
import com.barq.app.viewmodel.ThreadViewModel
import com.barq.app.viewmodel.UserProfileViewModel
import com.barq.app.viewmodel.NotificationsViewModel
import com.barq.app.viewmodel.ConsoleViewModel
import com.barq.app.viewmodel.DraftsViewModel
...
fun BarqNavHost() {
    ...
    // Tor state
    val torPrefs = remember { context.getSharedPreferences("barq_settings", android.content.Context.MODE_PRIVATE) }
    val torStatus by com.barq.app.relay.TorManager.status.collectAsState()
    val isTorEnabled = torStatus != com.barq.app.relay.TorStatus.DISABLED
    ...
    LaunchedEffect(Unit) {
        if (torPrefs.getBoolean("tor_enabled", false)) {
            com.barq.app.relay.TorManager.start()
        }
    }
    ...
    LaunchedEffect(torStatus) {
        ...
        if (torStatus == com.barq.app.relay.TorStatus.CONNECTED ||
            torStatus == com.barq.app.relay.TorStatus.DISABLED) {
    ...
    val onToggleTor: (Boolean) -> Unit = { enabled ->
        ...
        torScope.launch {
            if (enabled) {
                ...
                com.barq.app.relay.TorManager.stop()
            }
        }
    }
    ...
    val notifPrefs = remember { context.getSharedPreferences("barq_settings", Context.MODE_PRIVATE) }
    ...
    NavHost(
        ...
        composable(
            ...
            if (showThreadEmojiLibrary) {
                com.barq.app.ui.component.EmojiLibrarySheet(
        ...
        composable(
            ...
            val hashtagNoteActions = remember {
                com.barq.app.ui.component.NoteActions(
                    onReply = { event ->
                        replyTarget = event
                        quoteTarget = null
                        composeViewModel.clear()
