...
import com.barq.app.repo.BookmarkRepository
import com.barq.app.repo.BookmarkSetRepository
...
import com.barq.app.repo.SocialGraphDb
import com.barq.app.repo.Nip05Repository
import com.barq.app.repo.KeyRepository
import com.barq.app.repo.ListRepository
import com.barq.app.repo.MetadataFetcher
import com.barq.app.repo.DeletedEventsRepository
import com.barq.app.repo.MuteRepository
import com.barq.app.repo.NotificationRepository
import com.barq.app.repo.PinRepository
import com.barq.app.repo.ProfileRepository
import com.barq.app.repo.NwcRepository
import com.barq.app.repo.CustomEmojiRepository
import com.barq.app.repo.ZapPreferences
import com.barq.app.repo.RelayHintStore
import com.barq.app.repo.RelayInfoRepository
import com.barq.app.repo.TranslationRepository
import com.barq.app.repo.RelayListRepository
import com.barq.app.repo.RelaySetRepository
import com.barq.app.repo.ZapSender
...
class FeedViewModel(app: Application) : AndroidViewModel(app) {
    ...
    val selectedList: StateFlow<com.barq.app.nostr.FollowSet?> = listRepo.selectedList
    ...
    fun createEmojiSet(name: String, emojis: List<com.barq.app.nostr.CustomEmoji>) = listCrud.createEmojiSet(name, emojis)
    fun updateEmojiSet(dTag: String, title: String, emojis: List<com.barq.app.nostr.CustomEmoji>) = listCrud.updateEmojiSet(dTag, title, emojis)
    fun deleteEmojiSet(dTag: String) = listCrud.deleteEmojiSet(dTag)
    fun publishUserEmojiList(emojis: List<com.barq.app.nostr.CustomEmoji>, setRefs: List<String>) = listCrud.publishUserEmojiList(emojis, setRefs)
    ...
    fun setSelectedList(followSet: com.barq.app.nostr.FollowSet) {
