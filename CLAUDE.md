...
**Last updated:** April 7, 2026 (trust scores native path, per-pubkey favorites, feed sheet trust dots)
...
- (none — trust scores native + per-pubkey favorites + feed sheet trust dots shipped)
