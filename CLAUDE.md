...
| CardHydrator Phase1 Room pre-filter | hydrateProfiles() pre-filters candidate pubkeys against Room via ProfileResolver.filterUnresolved() + UserDao.getExistingPubkeys() — drops cached pubkeys before any coroutine/log/REQ. Eliminated 98% of Phase1 orchestration waste (959→19 calls on device) and 100% of "all fresh, skipping" (773→0) |
