...
**Last updated:** April 6, 2026 (crosspost relay hints + Bluesky CDN image detection, perf polish)
...
- Kind 6 reposts with original author profile resolution (p-tag extraction); bridged reposts (mostr.pub) with empty content fetch referenced event via lookupEvent with e-tag relay hints
